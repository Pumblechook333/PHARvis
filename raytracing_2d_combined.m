...
%         hop1 = 1:1:flags(1);
%         for ray_ind = hop1
%             set(ray_handle(ray_ind), 'color', 'r')
%         end
%     end
%         
%     if flags(2) > flags(1)
%         hop2 = flags(1):1:flags(2);
%         for ray_ind = hop2
%             set(ray_handle(ray_ind), 'color', 'g')
%         end
%     end
%             
%     if flags(3) > flags(2)
%         hop3 = flags(2):1:flags(3);
%         for ray_ind = hop3
%             set(ray_handle(ray_ind), 'color', 'b')
%         end
%     end
    ...
    filename = "PLOTS/2d_raytrace_combined/Z" + UT(4) + "_" + UT(5)+ ".png";
    % print -dpng filename
    if ~debug
