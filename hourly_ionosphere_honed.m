% Used to visualize path of 3D rays through generated 3D ionosphere
...
range = 100; % Only plots rays that fall within this distance of RX

%%
% Loop to quickly visualize simulated rays from multiple perspectives / at
% different times

rot = 90;   % Starting LOS (° of rotation)
i = rsta;
...
while i <= rsto
    ...
    for iii = 1:1:3
        x = points(iii,1); y = points(iii,2); z = points(iii,3);
        txt = "[" + x + ", " + y + ", " + z + "]";
